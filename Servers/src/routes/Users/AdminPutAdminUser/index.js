...
router.put('/swichtadmin/:id', passport_1.default.authenticate("jwt", { session: false }), (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (user && user.admin) {
            ...
            if (user && user.admin) {
                yield User_js_1.default.findByIdAndUpdate((id), { admin: false });
            }
            else {
