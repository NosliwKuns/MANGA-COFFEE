...
router.get('/state', passport_1.default.authenticate("jwt", { session: false }), (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { authorization } = req.headers;
    try {
        const data = (0, index_1.default)(authorization);
        yield User_js_1.default.findByIdAndUpdate(data.id, {
            status: false,
        });
