...
router.get('/historybuy/detail/:id', passport_1.default.authenticate('jwt', { session: false }), (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (user) {
            const historyDetail = user.historyBuy.filter((compra) => compra.idCompra === id);
