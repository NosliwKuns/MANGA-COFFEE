...
const index_15 = __importDefault(require("./Users/getEmail/index"));
const index_16 = __importDefault(require("./Users/DeleteUsers/index"));
const index_17 = __importDefault(require("./Users/GetConfirmarCuenta/index"));
const index_18 = __importDefault(require("./Users/DisabledUser/index"));
const index_19 = __importDefault(require("./Products/DeleteByIdProducts/index"));
const index_20 = __importDefault(require("./Products/FilterByIdProducts/index"));
const index_21 = __importDefault(require("./Products/FilterByNameProducts/index"));
const index_22 = __importDefault(require("./Products/GetFindAllProducts/index"));
const index_23 = __importDefault(require("./Products/PostProducts/index"));
const index_24 = __importDefault(require("./Products/FilterByCategory/index"));
const index_25 = __importDefault(require("./Products/PutProducts/index"));
const index_26 = __importDefault(require("./Products/PostCommentsProducts/index"));
const index_27 = __importDefault(require("./Products/PostBuyStripe/index"));
const index_28 = __importDefault(require("./Products/AddWishListProducts/index"));
const index_29 = __importDefault(require("./Mangas/PutManga/index"));
const index_30 = __importDefault(require("./Mangas/GetByFavorites/index"));
const index_31 = __importDefault(require("./Mangas/DeleteComments/index"));
const index_32 = __importDefault(require("./Mangas/postRating/index"));
const index_33 = __importDefault(require("./Products/DeleteItemsWishlistProducts/index"));
...
const index_38 = __importDefault(require("./Users/AdminPutAdminUser/index"));
const index_39 = __importDefault(require("./Users/AdminPutBlockUser/index"));
const index_40 = __importDefault(require("./Users/AdminPutStatusUser/index"));
...
router.use('/manga', index_32.default);
router.use('/user', index_18.default);
...
router.use('/user', index_40.default);
...
router.use('/products', index_28.default);
router.use('/products', index_33.default);
