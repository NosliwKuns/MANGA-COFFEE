...
const index_6 = __importDefault(require("./user/PostUserCreated/index"));
const index_7 = __importDefault(require("./user/PostUserinit/index"));
const index_8 = __importDefault(require("./user/GetByIdUser/index"));
