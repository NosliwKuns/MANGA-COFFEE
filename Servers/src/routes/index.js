...
const index_7 = __importDefault(require("./user/PostUserCreated/index"));
const index_8 = __importDefault(require("./user/PostUserinit/index"));
const index_9 = __importDefault(require("./user/GetByIdUser/index"));
const index_10 = __importDefault(require("./user/PutByIdUser/index"));
