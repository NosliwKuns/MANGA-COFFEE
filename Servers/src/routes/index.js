...
const index_13 = __importDefault(require("./Products/DeleteByIdProducts/index"));
const index_14 = __importDefault(require("./Products/FilterByIdProducts/index"));
const index_15 = __importDefault(require("./Products/FilterByNameProducts/index"));
const index_16 = __importDefault(require("./Products/GetFindAllProducts/index"));
const index_17 = __importDefault(require("./Products/PostProducts/index"));
const index_18 = __importDefault(require("./Products/FilterByCategory/index"));
